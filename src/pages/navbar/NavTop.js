...
function NavTop() {
    ...
    useEffect(()=>{
      setFilterData(userData.filter(item=>(item.name.toLowerCase().startsWith(searchText.toLowerCase()))));
    ...
    <div className={Styles.topbarContainer}>
               ...
               filterdata.map(item=>(
                <div className={Styles.dropdownContent}>
                  <div className={Styles.dropdownItem}>
                    <img  className={Styles.notificationprofile} src={item.profile}/>
                    <p>{item.name}</p>
                  </div>
              </div>
               ))
      ...
      <div className={Styles.topbarRight}>
        <div className={Styles.topbarLinks}>
          <Link to="/" className={Styles.topbarLink}>Homepage</Link>
        </div>
        ...
        <div>
        <label class={Styles.theme_switch} >
            <input type="checkbox" class={Styles.theme_switch__checkbox} onClick={switchTheme}/>
            <div class={Styles.theme_switch__container}>
              <div class={Styles.theme_switch__clouds}></div>
              <div class={Styles.theme_switch__stars_container} >
              ...
              <div class={Styles.theme_switch__circle_container}>
                <div class={Styles.theme_switch__sun_moon_container} >
                  <div class={Styles.theme_switch__moon}>
                    <div class={Styles.theme_switch__spot}></div>
                    <div class={Styles.theme_switch__spot}></div>
                    <div class={Styles.theme_switch__spot}></div>
                  </div>
                </div>
        ...
        <Link to="/profile">
          <img src={user.profilepic} className={Styles.topbarImg} alt=''/>
        </Link>
